...
const AboutUs = () => (
    <div className="personal-info-subsetting-column-aboutus">
        ...
        <div className="personal-info-subsetting-oneline">
            ...
            <p className="paragraph">altugaltuner6@gmail.com</p>
            <p className="paragraph">linkedin.com/in/altug-altuner/</p>
            <p className="paragraph">instagram/altugaltuner</p>
        </div>
    </div>
);
